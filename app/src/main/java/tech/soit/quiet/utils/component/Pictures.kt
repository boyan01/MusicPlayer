 ...
 * @param reuse if false,create a new bitmap to write the pixels
 */
fun Bitmap.blur(radius: Int, reuse: Boolean = true): Bitmap {
    return FastBlur.doBlur(this, radius, reuse)
}
